    ...
    await expect(res.json()).resolves.toEqual([
      {
        ...
        teacherClassTypeId: null,
        teacherClassTypeCode: null,
        teacherClassTypeLabelEn: null,
        teacherClassTypeLabelJa: null,
        teacherRateYen: 4000,
  ...
  test("returns duplicate duration options when teacher offers multiple lesson focuses", async () => {
      ...
      lessonOfferings: [
        {
          ...
          active: true,
          classTypeId: "ty-conv",
          classType: { id: "ty-conv", code: "conversation", labelEn: "Conversation", labelJa: "会話" },
        },
        {
          id: "off-gram-30",
          durationMin: 30,
          ...
          active: true,
          classTypeId: "ty-gram",
          classType: { id: "ty-gram", code: "grammar", labelEn: "Grammar", labelJa: "文法" },
        },
      ],
    });
    ...
    await expect(res.json()).resolves.toEqual([
      ...
      },
      {
        ...
        teacherClassTypeId: "ty-gram",
        teacherClassTypeCode: "grammar",
        teacherClassTypeLabelEn: "Grammar",
        teacherClassTypeLabelJa: "文法",
        teacherRateYen: 3600,
        teacherGroupSize: null,
        teacherIsGroupOffer: false,
      },
