...
**English Studio Japan** (“**we**,” “**us**,” or “**our**”) operates the website, applications, and related services (collectively, the “**Service**”). By accessing or using the Service, you agree to these Terms of Service (“**Terms**”). If you do not agree, do not use the Service.
...
The Service is operated under the name **English Studio Japan**. If we provide services through a separate legal entity (for example, a Japanese corporation), that entity may be identified on invoices, receipts, or account notices and is also bound by these Terms as applicable.

---

## 2. Changes

We may modify these Terms at any time. We will post the updated Terms and update the “Effective date” when we do. Your continued use of the Service after changes become effective constitutes acceptance of the revised Terms. If you do not agree, you must stop using the Service.
...
## 5. Independent teachers; no employment or agency

Teachers using the Service are independent of us unless expressly stated otherwise in writing. We do not employ teachers for your lessons solely by virtue of their use of the Service, and we are not a party to the instructional relationship between you and a teacher except as needed to operate the Service (for example, hosting, scheduling, and payment rails if offered).

We do not guarantee any particular learning outcome, test score, certification, or result.
...
- Upload malware, probe or bypass security, or interfere with the Service.
- Scrape, data-mine, or use automated means to access the Service in a way that burdens our systems or violates our policies.
...
## 8. Third-party services (including Google)

The Service may allow you to sign in, schedule, meet, store files, or otherwise interact using third-party products (for example, **Google** accounts, **Google Calendar**, **Google Meet**, or other providers).

Those third parties are **not** controlled by us. Their collection, use, storage, and sharing of information are governed by **your settings and permissions** with that provider and the provider’s own terms and policies. You are responsible for reviewing and managing those settings.

We are **not responsible** for third-party services, including outages, data loss, security incidents, pricing changes, or changes to third-party APIs or policies.
...
We and our licensors own the Service, including software, branding, and content we create (excluding content you upload). Subject to these Terms, we grant you a limited, non-exclusive, non-transferable, revocable license to use the Service for personal, non-commercial use unless we agree otherwise in writing.

You retain rights in content you submit, but you grant us a worldwide license to host, reproduce, process, display, and distribute your content as reasonably necessary to operate, secure, improve, and promote the Service.
...
We do not warrant that the Service will be uninterrupted, error-free, secure, or free of harmful components, or that defects will be corrected.
...
- **IN NO EVENT WILL ENGLISH STUDIO JAPAN, ITS AFFILIATES, DIRECTORS, OFFICERS, EMPLOYEES, AGENTS, SUPPLIERS, OR LICENSORS BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, EXEMPLARY, OR PUNITIVE DAMAGES, OR ANY LOSS OF PROFITS, REVENUE, GOODWILL, DATA, OR BUSINESS OPPORTUNITIES**, ARISING OUT OF OR RELATED TO YOUR USE OF THE SERVICE OR THESE TERMS, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
- **OUR TOTAL LIABILITY FOR ANY CLAIM ARISING OUT OF OR RELATING TO THE SERVICE OR THESE TERMS IS LIMITED TO THE GREATER OF (A) THE AMOUNTS YOU PAID US FOR THE SERVICE IN THE THREE (3) MONTHS BEFORE THE EVENT GIVING RISE TO LIABILITY, OR (B) ONE THOUSAND JAPANESE YEN (JPY 1,000), IF NO FEES WERE PAID.**

These limitations apply whether the claim sounds in contract, tort (including negligence), strict liability, or any other theory, and even if a limited remedy fails of its essential purpose.
...
You will defend, indemnify, and hold harmless English Studio Japan and its affiliates, directors, officers, employees, and agents from and against any claims, damages, losses, liabilities, costs, and expenses (including reasonable attorneys’ fees) arising out of or related to: (a) your use of the Service; (b) your content; (c) your violation of these Terms or law; or (d) your interaction with any teacher or other user.

---

## 14. Termination

You may stop using the Service at any time. We may suspend or terminate your access if we reasonably believe you violated these Terms, created risk, or must do so to comply with law. Provisions that by their nature should survive will survive (including Sections 10–18).

---

## 15. Governing law and venue

These Terms are governed by the **laws of Japan**, without regard to conflict-of-law principles. Subject to mandatory consumer protections that may apply in your jurisdiction, you agree that the courts located in **Tokyo, Japan** will have exclusive jurisdiction over disputes, unless otherwise required by applicable law.
...
You consent to receive communications from us electronically (including email and in-app notices).

---

## 18. Miscellaneous

These Terms constitute the entire agreement between you and us regarding the Service and supersede prior agreements on the subject. If any provision is unenforceable, the remaining provisions remain in effect. Our failure to enforce a provision is not a waiver. You may not assign these Terms without our consent; we may assign them in connection with a merger, acquisition, or sale of assets.

---

## 19. Contact

For questions about these Terms, contact us using the contact method we provide in the Service (for example, support email or in-app messaging), if available.
