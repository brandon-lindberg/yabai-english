  ...
  function StripeBrandButton(
    ...
    return (
      ...
      >
        ...
        <StripeWordmark height={14} />
        {loading ? (
          <span
            aria-hidden="true"
            className="ml-1 h-3 w-3 animate-spin rounded-full border-2 border-white/70 border-t-transparent"
          />
        ) : null}
      </button>
    );
